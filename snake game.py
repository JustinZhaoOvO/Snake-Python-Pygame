...
'''    setting argument '''
each_len = 30           #each units length  (Data representation - good variable names and types)
width_units = 20        #black screen width units
height_units = 20    #black screen height units
...
text_color = 0,0,255   #Set text colour
text_color_random = False #random text colour
FPs = 20    #snake movement FPs
...
t = 2
# vertical snake body
snakebody_vertical = pygame.image.load("snakebody竖.jpg") #add picture of vertical snake body   (picture files)
snakebody_vertical = pygame.transform.scale(snakebody_vertical, (each_len,each_len)) #size the picture
# transverse snake body
snakebody_transverse = pygame.image.load("snakebody横.png") #add picture of transverse snake body
...
snakehead_front = pygame.image.load("snakehead上.jpg")
snakehead_down = pygame.image.load("snakehead下.png")
snakehead_left = pygame.image.load("snakehead左.png")
snakehead_right = pygame.image.load("snakehead右.png")
...
if __name__  == '__main__':
    ...
    while True:  #(loops)
        ...
        restart = pygame.image.load("restart3.png")
        #Set the size
        ...
        if win:
            # the picture is "win!!"
            game_over = pygame.image.load("win.png")  # source : pngfree -> praying
        else:
            #if the game over, this picturn is "game over"
            game_over = pygame.image.load("game_over4.png")   #source : pngfree -> Khalilur Rahman
